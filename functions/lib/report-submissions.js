...
exports.submitReport = (0, https_1.onCall)({ cors: true }, async (request) => {
    ...
    try {
        ...
        logger.info("📋 Report Submission Function - Request data received:", {
            ...
            contentType: (_a = reportData.reportedContentInfo) === null || _a === void 0 ? void 0 : _a.contentType,
            contentId: (_b = reportData.reportedContentInfo) === null || _b === void 0 ? void 0 : _b.contentId,
            reporterUid: (_c = reportData.reporterInfo) === null || _c === void 0 ? void 0 : _c.uid,
        });
        // Validate input
        ...
        if (contentType === 'hangout') {
            ...
            contentExists = hangoutDoc.exists && !((_d = hangoutDoc.data()) === null || _d === void 0 ? void 0 : _d.deleted);
            logger.info("📋 Report Submission Function - Hangout verification:", {
                contentId,
                exists: hangoutDoc.exists,
                deleted: ((_e = hangoutDoc.data()) === null || _e === void 0 ? void 0 : _e.deleted) || false,
                contentExists,
            });
        }
        ...
        const reportDocument = {
            ...
            metadata: {
                ...
                userAgent: ((_g = (_f = request.rawRequest) === null || _f === void 0 ? void 0 : _f.headers) === null || _g === void 0 ? void 0 : _g["user-agent"]) || "unknown",
                ip: ((_h = request.rawRequest) === null || _h === void 0 ? void 0 : _h.ip) || "unknown",
            },
        };
        ...
        logger.error("💥 Report submission function error - Top level catch:", {
            ...
            reporterUid: ((_j = request.auth) === null || _j === void 0 ? void 0 : _j.uid) || "unauthenticated",
        });
        return {
            success: false,
...
//# sourceMappingURL=report-submissions.js.map